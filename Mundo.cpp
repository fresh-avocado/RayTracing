...
void Mundo::scene1() {
  ...
  addLightSource(new Luz(vec3(3, 17, 10), vec3::white(), 1.5, 1.5));
...
void Mundo::scene2() {
  ...
  // addLightSource(new Luz(vec3(-15, 10, 25), vec3::white()));
...
void Mundo::scene4() {
  ...
  addObj(new Esfera(vec3::yellow(), vec3(0, 5, 10), 2, 0.9, 0.1, 30));
